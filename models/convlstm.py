...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias):
        ...
        build_conv2d = lambda: nn.Conv2d(in_channels=self.input_dim + self.hidden_dim,
                              out_channels=self.hidden_dim,
                              kernel_size=self.kernel_size,
                              padding=self.padding,
                              bias=self.bias)
        self.conv_i = build_conv2d()
        self.conv_f = build_conv2d()
        self.conv_o = build_conv2d()
        self.conv_g = build_conv2d()
